...
class TestGroupPremiumPermissions(APITestCase):
    def setUp(self):
        group_name = "Premium"
        self.group = Group.objects.create(name=group_name)
        self.group.save()
        self.user = User.objects.create_user(username="PremiumTest", email="test@test.com", password="Panama2023")
        self.user.save()
    ...
    def test_logged_user(self):
        self.client.login(username="PremiumTest", password="Panama2023")
