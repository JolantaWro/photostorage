...
class TestGroupEnterPrisePermissions(APITestCase):
    def setUp(self):
        group_name = "Enterprise"
        self.group = Group.objects.create(name=group_name)
        self.group.save()
        self.user = User.objects.create_user(username="EnterpriseTest", email="test@test.com", password="Panama2023")
        self.user.save()
    ...
    def test_logged_user(self):
        self.client.login(username="EnterpriseTest", password="Panama2023")
